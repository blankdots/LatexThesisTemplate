...
\begin{figure}[h]
		\centering
		\IfFileExists{figures/sample.pdf}{%
			\includegraphics[width=6cm]{figures/sample.pdf}%
		}{\fbox{\parbox{6cm}{\centering\small Run \texttt{epstopdf figures/sample.eps}\\ to generate the figure.}}}
